...
let contentCommentReplySchema = mongoose.Schema({
...
contentCommentReplySchema.pre('save', async function (next) {
...
module.exports = mongoose.model("content_comment_replies", contentCommentReplySchema);
