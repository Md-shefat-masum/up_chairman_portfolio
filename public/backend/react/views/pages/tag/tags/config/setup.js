...
var setup = {
    ...
    route_prefix: 'tag',
    api_prefix: 'tag',
    layout_title: 'tag management',
    all_page_title: 'All tags',
    crate_page_title: 'Create tag',
    edit_page_title: 'Edit tag',
...
setup.actions.get_tags = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
