...
let prefix = 'photo_gallery_categorie';
var setup = {
    prefix,
    route_prefix: 'photo-gallery-categorie',
    api_prefix: 'photo-gallery-categorie',
    layout_title: 'photo gallery categorie management',
    all_page_title: 'All photo gallery categories',
    crate_page_title: 'Create photo gallery categorie ',
    edit_page_title: 'Edit photo gallery categorie ',
...
setup.actions.get_photo_gallery_categories = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
