...
let prefix = 'photo_gallery_image';
var setup = {
    prefix,
    route_prefix: 'photo-gallery-image',
    api_prefix: 'photo-gallery-image',
    layout_title: 'photo gallery image management',
    all_page_title: 'All photo gallery images',
    crate_page_title: 'Create photo gallery image ',
    edit_page_title: 'Edit photo gallery image ',
...
setup.actions.get_photo_gallery_images = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
