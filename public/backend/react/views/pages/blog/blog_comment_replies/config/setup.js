...
let prefix = 'blog_comment_reply';
var setup = {
    prefix,
    route_prefix: 'blog-comment-reply',
    api_prefix: 'blog-comment-reply',
    layout_title: 'blog comment reply management',
    all_page_title: 'All blog comment replies',
    crate_page_title: 'Create blog comment reply',
    edit_page_title: 'Edit blog comment reply',
...
setup.actions.get_blog_comment_replies = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
