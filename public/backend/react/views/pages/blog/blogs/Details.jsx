...
function Details() {
    ...
    if (data_store) {
        const { _id, title, subtitle, short_description, description, photo, photo_alt_text,url, seo_keyword, seo_description, seo_schema_tags, seo_title, published_date, createdAt, updatedAt, last_id } = data_store;
        return (
