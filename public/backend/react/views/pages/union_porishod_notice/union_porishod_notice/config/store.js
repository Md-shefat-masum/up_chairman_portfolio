...
export const async_actions = {
    ...
    [`fetch_all_data`]: createAsyncThunk(
        ...
        async (data, thunkAPI) => {
            ...
            let state = thunkAPI.getState().union_porishod_notice;
            let qparams = {
                page: state[`page`],
    ...
    [`store_${store_prefix}`]: createAsyncThunk(
        `union_porishod_notices/store_${store_prefix}`,
    ...
    [`edit_${store_prefix}`]: createAsyncThunk(
        `union_porishod_notices/edit_${store_prefix}`,
        async (form_data, thunkAPI) => {
            // console.log(thunkAPI);
            console.log('hoiche');
            try {
    ...
    [`details_${store_prefix}`]: createAsyncThunk(
        `union_porishod_notices/details_${store_prefix}`,
        async (id, thunkAPI) => {
            // console.log(id);
            try {
