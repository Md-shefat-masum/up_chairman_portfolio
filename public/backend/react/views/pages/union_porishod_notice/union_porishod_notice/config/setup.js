...
let prefix = 'union_porishod_notice';
var setup = {
    prefix,
    route_prefix: 'union-porishod-notice',
    api_prefix: 'union-porishod-notice',
    layout_title: 'union-porishod-notice management',
    all_page_title: 'All union porishod notices',
    crate_page_title: 'Create union porishod notice',
    edit_page_title: 'Edit union porishod notice',
...
setup.actions.get_union_porishod_notices = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
