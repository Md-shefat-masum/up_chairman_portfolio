...
let prefix = 'setting_title';
var setup = {
    prefix,
    route_prefix: 'setting-title',
    api_prefix: 'setting-title',
    layout_title: 'setting-title management',
    all_page_title: 'All setting titles',
    crate_page_title: 'Create setting title',
    edit_page_title: 'Edit setting title',
...
setup.actions.get_setting_titles = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
