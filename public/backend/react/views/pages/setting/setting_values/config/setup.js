...
let prefix = 'setting_value';
var setup = {
    prefix,
    route_prefix: 'setting-value',
    api_prefix: 'setting-value',
    layout_title: 'setting-value management',
    all_page_title: 'All setting values',
    crate_page_title: 'Create setting value',
    edit_page_title: 'Edit setting value',
...
setup.actions.get_setting_values = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
