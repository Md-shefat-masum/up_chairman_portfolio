...
let prefix = 'video_gallery_categorie';
var setup = {
    prefix,
    route_prefix: 'video-gallery-categorie',
    api_prefix: 'video-gallery-categorie',
    layout_title: 'video gallery categorie management',
    all_page_title: 'All video gallery categories',
    crate_page_title: 'Create video gallery categorie ',
    edit_page_title: 'Edit video gallery categorie ',
...
setup.actions.get_video_gallery_categories = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
