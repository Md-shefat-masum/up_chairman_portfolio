...
let prefix = 'video_gallery_image';
var setup = {
    prefix,
    route_prefix: 'video-gallery-image',
    api_prefix: 'video-gallery-image',
    layout_title: 'video gallery image management',
    all_page_title: 'All video gallery images',
    crate_page_title: 'Create video gallery image ',
    edit_page_title: 'Edit video gallery image ',
...
setup.actions.get_video_gallery_images = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
