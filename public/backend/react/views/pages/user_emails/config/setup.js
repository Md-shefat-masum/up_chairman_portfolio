...
let prefix = 'user_email';
var setup = {
    prefix,
    route_prefix: 'user-email',
    api_prefix: 'user-email',
    layout_title: 'user email management',
    all_page_title: 'All emails',
    crate_page_title: 'Create email',
    edit_page_title: 'Edit email',
    ...
    actions: {
        ...
        // set_user_email_search_parameter: async() => null,
    },
}
...
// setup.actions.get_user_emails = async () => await setup.dispatch(async_actions[`fetch_user_emails`]());
...
// get user-emails
setup.actions.get_user_emails = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
