...
let prefix = 'content_comment_reply';
var setup = {
    prefix,
    route_prefix: 'content-comment-reply',
    api_prefix: 'content-comment-reply',
    layout_title: 'content comment reply management',
    all_page_title: 'All content comment replies',
    crate_page_title: 'Create content comment reply',
    edit_page_title: 'Edit content comment reply',
...
setup.actions.get_content_comment_replies = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
