...
let prefix = 'content_comment';
var setup = {
    prefix,
    route_prefix: 'content-comment',
    api_prefix: 'content-comment',
    layout_title: 'content-comment management',
    all_page_title: 'All content comments',
    crate_page_title: 'Create content comment',
    edit_page_title: 'Edit content comment',
...
setup.actions.get_content_comments = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
