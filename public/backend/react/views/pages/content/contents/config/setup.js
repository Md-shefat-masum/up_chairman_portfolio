...
var setup = {
    ...
    api_prefix: 'content',
    layout_title: 'content management',
    all_page_title: 'All contents',
    crate_page_title: 'Create content',
...
setup.actions.get_contents = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
