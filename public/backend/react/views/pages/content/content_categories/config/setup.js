...
let prefix = 'content_categorie';
var setup = {
    prefix,
    route_prefix: 'content-categorie',
    api_prefix: 'content-categorie',
    layout_title: 'content-categorie management',
    all_page_title: 'All content categories',
    crate_page_title: 'Create content categorie',
    edit_page_title: 'Edit content categorie',
...
setup.actions.get_content_categories = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
