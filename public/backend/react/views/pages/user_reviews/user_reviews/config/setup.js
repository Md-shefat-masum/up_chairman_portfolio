...
let prefix = 'user_review';
var setup = {
    prefix,
    route_prefix: 'user-review',
    api_prefix: 'user-review',
    layout_title: 'user-review management',
    all_page_title: 'All user reviews',
    crate_page_title: 'Create user review',
    edit_page_title: 'Edit user review',
...
setup.actions.get_user_reviews = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
