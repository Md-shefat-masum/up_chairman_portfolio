...
var setup = {
    prefix,
    route_prefix: 'heading-title',
    api_prefix: 'heading-title',
    layout_title: 'heading title management',
    all_page_title: 'All heading titles',
    crate_page_title: 'Create heading title',
    edit_page_title: 'Edit heading title',
    ...
    actions: {
        ...
        // set_heading_title_search_parameter: async() => null,
    },
}
...
// setup.actions.get_heading_titles = async () => await setup.dispatch(async_actions[`fetch_heading_titles`]());
...
// get user-educations
setup.actions.get_heading_titles = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
