...
var setup = {
    prefix,
    route_prefix: 'site-url',
    api_prefix: 'site-url',
    layout_title: 'site url management',
    all_page_title: 'All site urls',
    crate_page_title: 'Create site url ',
    edit_page_title: 'Edit site url ',
...
setup.actions.get_site_urls = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
