...
let prefix = 'user_social_link';
var setup = {
    prefix,
    route_prefix: 'user-social-link',
    api_prefix: 'user-social-link',
    layout_title: 'user social link management',
    all_page_title: 'All social links',
    crate_page_title: 'Create social link',
    edit_page_title: 'Edit social link',
    ...
    actions: {
        ...
        // set_user_social_link_search_parameter: async() => null,
    },
}
...
// setup.actions.get_user_social_links = async () => await setup.dispatch(async_actions[`fetch_user_social_links`]());
...
// get user-social_links
setup.actions.get_user_social_links = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
