...
function Edit() {
  ...
  const { get_owner_intros, set_data, update_data } = setup.actions;
  ...
  if (data_store) {
    const { description, long_description, url, photo, photo_alt, seo_title, seo_keyword, seo_description, title, _id } = data_store;
    return (
