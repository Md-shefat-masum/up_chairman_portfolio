...
let prefix = 'owner_intro';
var setup = {
    prefix,
    route_prefix: 'owner-intro',
    api_prefix: 'owner-intro',
    layout_title: 'owner intro management',
    all_page_title: 'All owner intros',
    crate_page_title: 'Create owner intro ',
    edit_page_title: 'Edit owner intro ',
...
setup.actions.get_owner_intros = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
