...
let prefix = 'user_education';
var setup = {
    prefix,
    route_prefix: 'user-education',
    api_prefix: 'user-education',
    layout_title: 'user education management',
    all_page_title: 'All educations',
    crate_page_title: 'Create education',
    ...
    actions: {
        ...
        // set_user_education_search_parameter: async() => null,
    },
}
...
// setup.actions.get_user_educations = async () => await setup.dispatch(async_actions[`fetch_user_educations`]());
...
// get user-educations
setup.actions.get_user_educations = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
