...
let prefix = 'about_user';
var setup = {
    prefix,
    route_prefix: 'about-user',
    api_prefix: 'about-user',
    layout_title: 'about user management',
    all_page_title: 'All about users',
    crate_page_title: 'Create about user',
    edit_page_title: 'Edit about user',
    ...
    actions: {
        ...
        // set_about_user_search_parameter: async() => null,
    },
}
...
// setup.actions.get_about_users = async () => await setup.dispatch(async_actions[`fetch_about_users`]());
...
// get user-educations
setup.actions.get_about_users = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
