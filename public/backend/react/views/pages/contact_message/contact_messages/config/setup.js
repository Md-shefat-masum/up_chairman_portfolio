...
let prefix = 'contact_message';
var setup = {
    prefix,
    route_prefix: 'contact-message',
    api_prefix: 'contact-message',
    layout_title: 'contact-message management',
    all_page_title: 'All contact messages',
    crate_page_title: 'Create contact message',
    edit_page_title: 'Edit contact message',
...
setup.actions.get_contact_messages = async (id) => await setup.dispatch(async_actions[`details_${setup.prefix}`](id))
